...
function updateAvg(avgLeft) {
    ...
    if (avgLeftRounded > 100)
        $("#puratatcb").addClass("btn-danger").removeClass("btn-success btn-primary btn-warning")
    else if (avgLeftRounded > 90)
        $("#puratatcb").addClass("btn-warning").removeClass("btn-success btn-primary btn-danger")
    else if (avgLeftRounded > 0)
        $("#puratatcb").addClass("btn-success").removeClass("btn-primary btn-warning btn-danger")
    else
        $("#puratatcb").addClass("btn-primary").removeClass("btn-success btn-warning btn-danger")
...
function calcTarget() {
    if (target === "x"){
        ...
        if (calculatedPurata[3] !== 0) {
            let avgLeft = (target * actualTotalPemberat - calculatedPurata[1]) / calculatedPurata[3]
            updateAvg(avgLeft)
        } else {
            updateAvg(0)
        }
