        ...
        <div class="main row align-content-start">
            <div class="col">
                <div class="align-content-md-center mb-3 text-capitalize fw-bolder text-wrap fs-3">
                    <span class="badge btn-success btn" id="puratatc"><span id="text"></span> </span>
                </div>
            ...
            <div class="row align-content-center">
                <button class="btn btn-outline-secondary" onclick="calculateTargetAverage()">Refresh</button>
            </div>
        </div>
        <div class="err"></div>
    </div>
